...
{
    public class ButtonControl : MonoBehaviour, IMidiNoteListener
    {
        [Tooltip("The Midi Animator Core that will drive this Control")]
        public MidiAnimatorCore midiAnimatorCore;
        [Tooltip("The GameObject representing the button in the \"inactive\" state")]
        public GameObject ButtonObject;
        [Tooltip("The GameObject representing the button in the \"active\" state")]
        public GameObject AltButtonObject;
        ...
        public void Start()
        {
            ...
            AltButtonObject.SetActive(false);
        }
        ...
        public void SetNoteOn(int noteNumber, int channel, int newValue)
        {
            ...
            AltButtonObject.SetActive(true);
        }
